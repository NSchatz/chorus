...
| AC-9 | `--test report_shape` | one new file, carrying the commit, whether the tree was clean, 96000 Hz, "32 offered, 32 used", and all three lag figures. A dirty tree is reported as dirty, asserted separately so a report that always said "clean" would fail |
